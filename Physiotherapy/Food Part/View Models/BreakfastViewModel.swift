...
class BreakfastViewModel: ObservableObject {
    ...
    static let shared = BreakfastViewModel()
    static let APIKey = "16BPm6TsGFIZGFxln"
    
    
    var retreivedItems: [Item] = []
    ...
    private var _gramsString: String = "" {
            willSet {
        ...
        var gramsString: String {
            ...
            set {
                _gramsString = newValue
            }
        }

        var grams: Int {
            return Int(gramsString) ?? 0
        }
    ...
    func fetchDataFromAPI(foodName: String, retryCount: Int = 3, completion: @escaping (Data?, Error?) -> Void) {
        ...
        URLSession.shared.dataTask(with: url) { [self] data, response, error in
            ...
            do {
                ...
                if !decodedData.items.isEmpty {
                    ...
                    self.retreivedItems = decodedData.items
                    completion(data, nil)
        ...
        let _ = URLSession.shared.dataTaskPublisher(for: url)
            ...
            .sink { completion in
                ...
                self.retreivedItems = foodItems.items
            }
